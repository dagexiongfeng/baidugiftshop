  ...
  <table id="show" border="1 #76aef0 solid" cellspacing="0" cellpadding="1" align="center" bgColor="#E4E8EF" width="1024" border="0">
   ...
   <s:iterator value="#request.pageBean" id="pageBean">
    <tr>
      ...
      <a href="ListAllOrder.action?page=<s:property value="#pageBean.firstPage"/>">首页</a>
      <a href="ListAllOrder.action?page=<s:property value="#pageBean.previousPage"/>">上一页</a>
      <a href="ListAllOrder.action?page=<s:property value="#pageBean.nextPage"/>">下一页</a>
      <a href="ListAllOrder.action?page=<s:property value="#pageBean.lastPage"/>">尾页</a>
