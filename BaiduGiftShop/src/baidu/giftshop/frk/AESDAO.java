...
public class AESDAO {
	...
	/*public static void main(String[] args) throws Exception {  
        ...
        String encrytStr = encrytStr(str);
        System.out.println("加密后："+encrytStr);  
          
        //加密过的16进制的字符串转化成二进制数组  
        String encrytByte = desCrytStr(encrytStr);      
        System.out.println("解密后："+ encrytByte);  
        
    }*/
	
	//加密过程类
	public static String encrytStr(String str) throws Exception{
		String key="fengjun";
		byte[] byteRe = enCrypt(str,key);  
        //加密过的二进制数组转化成16进制的字符串  
    ...
    public static String desCrytStr(String str) throws Exception{
    	String key = "fengjun";
    	byte[] encrytByte = parseHexStr2Byte(str);         
    	String desCrytStr=deCrypt(encrytByte,key);  
    	return desCrytStr;
    }
    /** 
     * 加密函数 
